    ...
    : AudioProcessorEditor (ownerFilter)
{
    ...
    sld_az_1->setDoubleClickReturnValue(true, 0.f);
    ...
    sld_el_1->setDoubleClickReturnValue(true, 0.f);
    ...
    sld_w_1->setDoubleClickReturnValue(true, 18.f);
    ...
    sld_h_1->setDoubleClickReturnValue(true, 18.f);
    ...
    btn_solo_1->setClickingTogglesState(true);
    ...
    sld_gain_1->setDoubleClickReturnValue(true, 0.f);
    ...
    sld_az_2->setDoubleClickReturnValue(true, 0.f);
    ...
    sld_el_2->setDoubleClickReturnValue(true, 0.f);
    ...
    sld_w_2->setDoubleClickReturnValue(true, 18.f);
    ...
    sld_h_2->setDoubleClickReturnValue(true, 18.f);
    ...
    btn_solo_2->setClickingTogglesState(true);
    ...
    sld_gain_2->setDoubleClickReturnValue(true, 0.f);
...
void Ambix_directional_loudnessAudioProcessorEditor::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    if (buttonThatWasClicked == btn_solo_1)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::WindowParam, buttonThatWasClicked->getToggleState() ? 1.f : 0.f);
    }
    else if (buttonThatWasClicked == btn_solo_2)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::WindowParam, buttonThatWasClicked->getToggleState() ? 1.f : 0.f);
    }
...
void Ambix_directional_loudnessAudioProcessorEditor::changeListenerCallback (ChangeBroadcaster *source)
{
    ...
    float az_1 = ParamToDeg360( ourProcessor->getParameter(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::AzimuthParam) );
    sld_az_1->setValue(az_1, dontSendNotification);
    
    float el_1 = ParamToDeg360( ourProcessor->getParameter(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::ElevationParam) );
    sld_el_1->setValue(el_1, dontSendNotification);
    
    
    bool sh_1 = ourProcessor->getParameter(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::ShapeParam) <= 0.5f ? false : true;
    
    box_shape_1->setSelectedId(sh_1 ? 2 : 1);
    
    sld_h_1->setEnabled(sh_1);
        
    float w_1 = ParamToDeg180(ourProcessor->getParameter(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::WidthParam) );
    sld_w_1->setValue(w_1 , dontSendNotification);
    
    float h_1 = ParamToDeg180( ourProcessor->getParameter(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::HeightParam) );
    sld_h_1->setValue(h_1, dontSendNotification);
    
    float g_1 = ParamToDB( ourProcessor->getParameter(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::GainParam) );
    
    
    sld_gain_1->setValue(g_1, dontSendNotification);
    
    bool s_1 = ourProcessor->getParameter(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::WindowParam) > 0.5f ? true : false;
    
    btn_solo_1->setToggleState(s_1, dontSendNotification);
    
    
    /////////////////////
    
    float az_2 = ParamToDeg360( ourProcessor->getParameter(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::AzimuthParam) );
    sld_az_2->setValue(az_2, dontSendNotification);
    
    float el_2 = ParamToDeg360( ourProcessor->getParameter(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::ElevationParam) );
    sld_el_2->setValue(el_2, dontSendNotification);
    
    
    bool sh_2 = ourProcessor->getParameter(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::ShapeParam) <= 0.5f ? false : true;
    
    box_shape_2->setSelectedId(sh_2 ? 2 : 1);
    
    sld_h_2->setEnabled(sh_2);
    
    float w_2 = ParamToDeg180(ourProcessor->getParameter(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::WidthParam) );
    sld_w_2->setValue(w_2 , dontSendNotification);
    
    float h_2 = ParamToDeg180( ourProcessor->getParameter(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::HeightParam) );
    sld_h_2->setValue(h_2, dontSendNotification);
    
    
    
    float g_2 = ParamToDB( ourProcessor->getParameter(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::GainParam) );
    
    sld_gain_2->setValue(g_2, dontSendNotification);
    
    bool s_2 = ourProcessor->getParameter(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::WindowParam) > 0.5f ? true : false;
    
    btn_solo_2->setToggleState(s_2, dontSendNotification);
    
    
    panninggraph->setOneFilterSolo((s_1 || s_2));
    
    panninggraph->setFilter(0, az_1, el_1, sh_1, w_1, h_1, g_1, s_1);
    
    panninggraph->setFilter(1, az_2, el_2, sh_2, w_2, h_2, g_2, s_2);
...
void Ambix_directional_loudnessAudioProcessorEditor::sliderValueChanged (Slider* sliderThatWasMoved)
{
    ...
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::AzimuthParam, Deg360ToParam(sliderThatWasMoved->getValue()) );
    }
    else if (sliderThatWasMoved == sld_el_1)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::ElevationParam, Deg360ToParam(sliderThatWasMoved->getValue()) );
    }
    else if (sliderThatWasMoved == sld_w_1)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::WidthParam, Deg180ToParam(sliderThatWasMoved->getValue()) );
    }
    else if (sliderThatWasMoved == sld_h_1)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::HeightParam, Deg180ToParam(sliderThatWasMoved->getValue()) );
    }
    else if (sliderThatWasMoved == sld_gain_1)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::GainParam, DbToParam(sliderThatWasMoved->getValue()) );
    }
    else if (sliderThatWasMoved == sld_az_2)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::AzimuthParam, Deg360ToParam(sliderThatWasMoved->getValue()) );
    }
    else if (sliderThatWasMoved == sld_el_2)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::ElevationParam, Deg360ToParam(sliderThatWasMoved->getValue()) );
    }
    else if (sliderThatWasMoved == sld_w_2)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::WidthParam, Deg180ToParam(sliderThatWasMoved->getValue()) );
    }
    else if (sliderThatWasMoved == sld_h_2)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::HeightParam, Deg180ToParam(sliderThatWasMoved->getValue()) );
    }
    else if (sliderThatWasMoved == sld_gain_2)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::GainParam, DbToParam(sliderThatWasMoved->getValue()) );
    }
...
void Ambix_directional_loudnessAudioProcessorEditor::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
    ...
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*0+Ambix_directional_loudnessAudioProcessor::ShapeParam, (float)comboBoxThatHasChanged->getSelectedId()-1.f);
    }
    else if (comboBoxThatHasChanged == box_shape_2)
    {
        ourProcessor->setParameterNotifyingHost(PARAMS_PER_FILTER*1+Ambix_directional_loudnessAudioProcessor::ShapeParam, (float)comboBoxThatHasChanged->getSelectedId()-1.f);
    }
