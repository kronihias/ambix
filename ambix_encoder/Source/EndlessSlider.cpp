...
class EndlessSlider::Pimpl   : public AsyncUpdater,
                        public ButtonListener,  // (can't use Button::Listener due to idiotic VC2005 bug)
                        public LabelListener,
                        public ValueListener
{
public:
    Pimpl (EndlessSlider& s, SliderStyle sliderStyle, TextEntryBoxPosition textBoxPosition)
      : owner (s),
        style (sliderStyle),
    ...
    void handleAsyncUpdate() override
    {
        ...
        listeners.callChecked (checker, &SliderListener::sliderValueChanged, slider);  // (can't use EndlessSlider::Listener due to idiotic VC2005 bug)
    }
    ...
    void sendDragStart()
    {
        ...
        Component::BailOutChecker checker (&owner);
        EndlessSlider* slider = &owner; // (must use an intermediate variable here to avoid a VS2005 compiler bug)
    ...
    static void sliderMenuCallback (const int result, EndlessSlider* slider)
    {
        if (slider != nullptr)
        {
            switch (result)
    ...
    void paint (Graphics& g, LookAndFeel& lf)
    {
        if (style != IncDecButtons)
        {
            ...
            {
                g.setColour (owner.findColour (EndlessSlider::textBoxOutlineColourId));
...
//==============================================================================
EndlessSlider::EndlessSlider()
{
    init (LinearHorizontal, TextBoxLeft);
}

EndlessSlider::EndlessSlider (const String& name)  : Component (name)
{
    init (LinearHorizontal, TextBoxLeft);
}

EndlessSlider::EndlessSlider (SliderStyle style, TextEntryBoxPosition textBoxPos)
{
    init (style, textBoxPos);
}

void EndlessSlider::init (SliderStyle style, TextEntryBoxPosition textBoxPos)
{
    ...
    EndlessSlider::lookAndFeelChanged();
    updateText();
...
//==============================================================================
void EndlessSlider::addListener (SliderListener* const listener)       { pimpl->listeners.add (listener); }
void EndlessSlider::removeListener (SliderListener* const listener)    { pimpl->listeners.remove (listener); }

//==============================================================================
EndlessSlider::SliderStyle EndlessSlider::getSliderStyle() const noexcept     { return pimpl->style; }
void EndlessSlider::setSliderStyle (const SliderStyle newStyle)        { pimpl->setSliderStyle (newStyle); }

void EndlessSlider::setRotaryParameters (const float startAngleRadians, const float endAngleRadians, const bool stopAtEnd)
{
    pimpl->setRotaryParameters (startAngleRadians, endAngleRadians, stopAtEnd);
}

void EndlessSlider::setVelocityBasedMode (bool vb)                 { pimpl->isVelocityBased = vb; }
bool EndlessSlider::getVelocityBasedMode() const noexcept          { return pimpl->isVelocityBased; }
bool EndlessSlider::getVelocityModeIsSwappable() const noexcept    { return pimpl->userKeyOverridesVelocity; }
int EndlessSlider::getVelocityThreshold() const noexcept           { return pimpl->velocityModeThreshold; }
double EndlessSlider::getVelocitySensitivity() const noexcept      { return pimpl->velocityModeSensitivity; }
double EndlessSlider::getVelocityOffset() const noexcept           { return pimpl->velocityModeOffset; }

void EndlessSlider::setVelocityModeParameters (const double sensitivity, const int threshold,
                                        const double offset, const bool userCanPressKeyToSwapMode)
{
    jassert (threshold >= 0);
...
double EndlessSlider::getSkewFactor() const noexcept               { return pimpl->skewFactor; }
void EndlessSlider::setSkewFactor (const double factor)            { pimpl->skewFactor = factor; }

void EndlessSlider::setSkewFactorFromMidPoint (const double sliderValueToShowAtMidPoint)
{
    pimpl->setSkewFactorFromMidPoint (sliderValueToShowAtMidPoint);
}

int EndlessSlider::getMouseDragSensitivity() const noexcept        { return pimpl->pixelsForFullDragExtent; }

void EndlessSlider::setMouseDragSensitivity (const int distanceForFullScaleDrag)
{
...
void EndlessSlider::setIncDecButtonsMode (const IncDecButtonMode mode)             { pimpl->setIncDecButtonsMode (mode); }

EndlessSlider::TextEntryBoxPosition EndlessSlider::getTextBoxPosition() const noexcept    { return pimpl->textBoxPos; }
int EndlessSlider::getTextBoxWidth() const noexcept                                { return pimpl->textBoxWidth; }
int EndlessSlider::getTextBoxHeight() const noexcept                               { return pimpl->textBoxHeight; }

void EndlessSlider::setTextBoxStyle (const TextEntryBoxPosition newPosition, const bool isReadOnly,
...
bool EndlessSlider::isTextBoxEditable() const noexcept                     { return pimpl->editableText; }
void EndlessSlider::setTextBoxIsEditable (const bool shouldBeEditable)     { pimpl->setTextBoxIsEditable (shouldBeEditable); }
void EndlessSlider::showTextBox()                                          { pimpl->showTextBox(); }
void EndlessSlider::hideTextBox (const bool discardCurrentEditorContents)  { pimpl->hideTextBox (discardCurrentEditorContents); }

void EndlessSlider::setChangeNotificationOnlyOnRelease (bool onlyNotifyOnRelease)
{
    pimpl->sendChangeOnlyOnRelease = onlyNotifyOnRelease;
}

bool EndlessSlider::getSliderSnapsToMousePosition() const noexcept                 { return pimpl->snapsToMousePos; }
void EndlessSlider::setSliderSnapsToMousePosition (const bool shouldSnapToMouse)   { pimpl->snapsToMousePos = shouldSnapToMouse; }

void EndlessSlider::setPopupDisplayEnabled (const bool enabled, Component* const parentComponentToUse)
{
    pimpl->popupDisplayEnabled = enabled;
    pimpl->parentForPopupDisplay = parentComponentToUse;
}

Component* EndlessSlider::getCurrentPopupDisplay() const noexcept      { return pimpl->popupDisplay.get(); }

//==============================================================================
void EndlessSlider::colourChanged()        { lookAndFeelChanged(); }
void EndlessSlider::lookAndFeelChanged()   { pimpl->lookAndFeelChanged (getLookAndFeel()); }
void EndlessSlider::enablementChanged()    { repaint(); pimpl->updateTextBoxEnablement(); }

//==============================================================================
double EndlessSlider::getMaximum() const noexcept      { return pimpl->maximum; }
double EndlessSlider::getMinimum() const noexcept      { return pimpl->minimum; }
double EndlessSlider::getInterval() const noexcept     { return pimpl->interval; }

void EndlessSlider::setRange (double newMin, double newMax, double newInt)
{
    pimpl->setRange (newMin, newMax, newInt);
}

Value& EndlessSlider::getValueObject() noexcept        { return pimpl->currentValue; }
Value& EndlessSlider::getMinValueObject() noexcept     { return pimpl->valueMin; }
Value& EndlessSlider::getMaxValueObject() noexcept     { return pimpl->valueMax; }

double EndlessSlider::getValue() const                 { return pimpl->getValue(); }

void EndlessSlider::setValue (double newValue, const NotificationType notification)
{
    pimpl->setValue (newValue, notification);
}

double EndlessSlider::getMinValue() const      { return pimpl->getMinValue(); }
double EndlessSlider::getMaxValue() const      { return pimpl->getMaxValue(); }

void EndlessSlider::setMinValue (double newValue, const NotificationType notification, bool allowNudgingOfOtherValues)
{
    pimpl->setMinValue (newValue, notification, allowNudgingOfOtherValues);
}

void EndlessSlider::setMaxValue (double newValue, const NotificationType notification, bool allowNudgingOfOtherValues)
{
    pimpl->setMaxValue (newValue, notification, allowNudgingOfOtherValues);
}

void EndlessSlider::setMinAndMaxValues (double newMinValue, double newMaxValue, const NotificationType notification)
{
    pimpl->setMinAndMaxValues (newMinValue, newMaxValue, notification);
}

void EndlessSlider::setDoubleClickReturnValue (bool isDoubleClickEnabled,  double valueToSetOnDoubleClick)
{
    pimpl->doubleClickToValue = isDoubleClickEnabled;
    pimpl->doubleClickReturnValue = valueToSetOnDoubleClick;
}

double EndlessSlider::getDoubleClickReturnValue() const noexcept       { return pimpl->doubleClickReturnValue; }
bool EndlessSlider::isDoubleClickReturnEnabled() const noexcept        { return pimpl->doubleClickToValue; }

void EndlessSlider::updateText()
{
    pimpl->updateText();
}

void EndlessSlider::setTextValueSuffix (const String& suffix)
{
    pimpl->setTextValueSuffix (suffix);
}

String EndlessSlider::getTextValueSuffix() const
{
    return pimpl->textSuffix;
}

String EndlessSlider::getTextFromValue (double v)
{
...
double EndlessSlider::getValueFromText (const String& text)
{
...
double EndlessSlider::proportionOfLengthToValue (double proportion)
{
...
double EndlessSlider::valueToProportionOfLength (double value)
{
...
double EndlessSlider::snapValue (double attemptedValue, DragMode)
{
    return attemptedValue;
}

int EndlessSlider::getNumDecimalPlacesToDisplay() const noexcept    { return pimpl->numDecimalPlaces; }

//==============================================================================
int EndlessSlider::getThumbBeingDragged() const noexcept            { return pimpl->sliderBeingDragged; }

void EndlessSlider::startedDragging() {}
void EndlessSlider::stoppedDragging() {}
void EndlessSlider::valueChanged() {}

//==============================================================================
void EndlessSlider::setPopupMenuEnabled (const bool menuEnabled)   { pimpl->menuEnabled = menuEnabled; }
void EndlessSlider::setScrollWheelEnabled (const bool enabled)     { pimpl->scrollWheelEnabled = enabled; }
void EndlessSlider::setScrollWheelEndless (const bool enabled)     { pimpl->scrollWheelEndless = enabled; }

bool EndlessSlider::isHorizontal() const noexcept                  { return pimpl->isHorizontal(); }
bool EndlessSlider::isVertical() const noexcept                    { return pimpl->isVertical(); }
bool EndlessSlider::isRotary() const noexcept                      { return pimpl->isRotary(); }
bool EndlessSlider::isBar() const noexcept                         { return pimpl->isBar(); }

float EndlessSlider::getPositionOfValue (const double value)       { return pimpl->getPositionOfValue (value); }

//==============================================================================
void EndlessSlider::paint (Graphics& g)        { pimpl->paint (g, getLookAndFeel()); }
void EndlessSlider::resized()                  { pimpl->resized (getLookAndFeel()); }

void EndlessSlider::focusOfChildComponentChanged (FocusChangeType)     { repaint(); }

void EndlessSlider::mouseDown (const MouseEvent& e)    { pimpl->mouseDown (e); }
void EndlessSlider::mouseUp (const MouseEvent&)        { pimpl->mouseUp(); }

void EndlessSlider::modifierKeysChanged (const ModifierKeys& modifiers)
{
    if (isEnabled())
        pimpl->modifierKeysChanged (modifiers);
}

void EndlessSlider::mouseDrag (const MouseEvent& e)
{
    if (isEnabled())
        pimpl->mouseDrag (e);
}

void EndlessSlider::mouseDoubleClick (const MouseEvent&)
{
    if (isEnabled())
        pimpl->mouseDoubleClick();
}

void EndlessSlider::mouseWheelMove (const MouseEvent& e, const MouseWheelDetails& wheel)
{
