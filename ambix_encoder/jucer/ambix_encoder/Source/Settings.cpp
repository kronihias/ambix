...
<JUCER_COMPONENT documentType="Component" className="Settings" componentName=""
  ...
  <BACKGROUND backgroundColour="ffffffff">
    ...
    <TEXT pos="-2 2 208 30" fill="solid: ffffffff" hasStroke="0" text="ambix_encoder settings"
  ...
  <SLIDER name="new slider" id="70bdbe1a6d977cf1" memberName="slider" virtualName=""
          ...
          thumbcol="ff000000" rotarysliderfill="ff000000" min="1" max="1000"
          int="1" style="RotaryHorizontalVerticalDrag" textBoxPos="TextBoxLeft"
          textBoxEditable="1" textBoxWidth="60" textBoxHeight="20" skewFactor="0.2999999999999999889"/>
</JUCER_COMPONENT>
