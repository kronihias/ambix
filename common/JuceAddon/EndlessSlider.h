...
/**
    ...
    @see Slider::Listener
*/
class JUCE_API  EndlessSlider  : public Component,
...
public:
    ...
    */
    ...
    /** Creates a slider.
        When created, you can set up the slider's style and range with setSliderStyle(), setRange(), etc.
    */
    explicit EndlessSlider (const String& componentName);

    /** Creates a slider with some explicit options. */
    EndlessSlider (SliderStyle style, TextEntryBoxPosition textBoxPosition);
    ...
    */
    ...
    public:
        ...
        */
        virtual void sliderValueChanged (EndlessSlider* slider) = 0;
        ...
        */
        virtual void sliderDragStarted (EndlessSlider*) {}

        /** Called after a drag operation has finished.
            @see sliderDragStarted, Slider::stoppedDragging
        */
        virtual void sliderDragEnded (EndlessSlider*) {}
    };
